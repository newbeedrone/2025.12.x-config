...
#undef _USER_VTX_TABLE_MAX_POWER_LEVELS
    ...
    /* Motors */
    motorConfigMutable()->motorIdle = 600;
    motorConfigMutable()->dev.useDshotTelemetry = DSHOT_TELEMETRY_ON;
    motorConfigMutable()->dev.useBurstDshot = DSHOT_DMAR_ON;
    motorConfigMutable()->dev.motorProtocol = PWM_TYPE_DSHOT300;
    motorConfigMutable()->dev.useDshotBitbangedTimer = DSHOT_BITBANGED_TIMER_AUTO;
    ...
    pidProfilesMutable(0)->dyn_idle_max_increase = 60;
