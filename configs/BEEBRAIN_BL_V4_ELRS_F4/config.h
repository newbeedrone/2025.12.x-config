...
#define BOARD_NAME        BEEBRAIN_BL_V4_ELRS_F4
#define MANUFACTURER_ID   NBD
#define TARGET_BOARD_IDENTIFIER         "BLV4 ELRS 65"
#define USBD_PRODUCT_STRING             "BLV4"
...
#define DEFAULT_VOLTAGE_METER_SCALE     114
