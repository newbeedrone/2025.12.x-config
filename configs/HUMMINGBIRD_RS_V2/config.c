...
void targetConfiguration(void) {
    ...
    featureConfigMutable()->enabledFeatures |= (FEATURE_SERVO_TILT | FEATURE_TELEMETRY | FEATURE_OSD | FEATURE_CHANNEL_FORWARDING | FEATURE_LED_STRIP | FEATURE_RANGEFINDER);
...
#undef _USER_VTX_TABLE_MAX_POWER_LEVELS
    ...
    osdElementConfigMutable()->item_pos[OSD_CRAFT_NAME]         = OSD_PROFILE_1_FLAG | OSD_POS(10 ,11);
    ...
    gyroConfigMutable()->gyro_lpf1_dyn_max_hz = 500;
    accelerometerConfigMutable()->accZero.raw[0] = 1;
    accelerometerConfigMutable()->accZero.raw[1] = -2;
    accelerometerConfigMutable()->accZero.raw[2] = 45;
    accelerometerConfigMutable()->accZero.raw[3] = 1;
    pidProfilesMutable(0)->iterm_relax_cutoff = 45;
    pidProfilesMutable(0)->dyn_idle_min_rpm = 125;
    pidProfilesMutable(0)->dyn_idle_max_increase = 100;
    ...
    pidProfilesMutable(0)->pid[PID_YAW].P = 42;
    pidProfilesMutable(0)->pid[PID_YAW].I = 83;
    pidProfilesMutable(0)->pid[PID_YAW].F = 138;
    pidProfilesMutable(0)->pid[FD_ROLL].D = 25;
    pidProfilesMutable(0)->pid[FD_PITCH].D = 30;
